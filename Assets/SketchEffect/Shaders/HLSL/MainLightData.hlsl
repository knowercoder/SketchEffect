...
//This script to be used in a custom shader node to acess the main directional light data

#ifndef MAINLIGHT_INCLUDED
#define MAINLIGHT_INCLUDED

void MainLightData_float(out half3 direction, out half3 color, out half distanceAttenuation, out half shadowAttenuation)
{
